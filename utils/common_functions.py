...
def post_process_transpose(
    ...
    **kwargs: dict
    ...
    if len(op_rep_params) >=1:
        ...
        if len(transposed_value.shape) == 3:
            transposed_value = tf.transpose(a=value_before_transpose,perm=[0,2,1])
        elif len(transposed_value.shape) == 4 :
            transposed_value = tf.transpose(a=value_before_transpose,perm=[0,2,3,1])
        else:
            pass
# upto
